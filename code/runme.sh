...
##python sim_batch.py -c config/config7.json -p 55000 -v f -f ./paths/paths_2016-02-22.pickle >config7.log 2>&1 &
##python sim_batch.py -c config/config8.json -p 55000 -v f -f ./paths/paths_2016-02-22.pickle >config8.log 2>&1 &
##python sim_batch.py -c config/config9.json -p 55000 -v f -f ./config9.pickle >config9.log 2>&1 &
#=======
#<<<<<<< HEAD
